...
{
    lowCellVoltage_ = (lowCellVoltage / TEN);
...
{
    highCellVoltage_ = (highCellVoltage / TEN);
...
{
    averageCellVoltage_ = (averageCellVoltage / TEN);
