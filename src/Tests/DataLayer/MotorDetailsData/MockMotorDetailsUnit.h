...
public:
    ...
    MOCK_CONST_METHOD0(getBackEmf, float());
    ...
    MOCK_CONST_METHOD0(getMotorTemperature, float());
    ...
    MOCK_METHOD1(setBackEmf, void(const float&));
    ...
    MOCK_METHOD1(setMotorTemperature, void(const float&));
